(function ($) {
      ...
      <figure class="image-figure ${imageData.align} ${imageData.display || 'wrap-text'}" data-image-id="${imgId}">
        <div class="image-container">
          <img id="${imgId}" 
               ...
               data-type="image"
               style="width: ${imageData.size}%; height: auto;">
          ...
          <div class="image-toolbar" style="display: none;">
            <button class="img-btn" data-action="replace" title="Replace Image"><i class="fas fa-image"></i></button>
            <button class="img-btn" data-action="wrap-left" title="Wrap Text Left"><i class="fas fa-align-left"></i></button>
            <button class="img-btn" data-action="break-center" title="Break Text (Center)"><i class="fas fa-align-center"></i></button>
            <button class="img-btn" data-action="wrap-right" title="Wrap Text Right"><i class="fas fa-align-right"></i></button>
            <button class="img-btn" data-action="inline" title="Inline with Text"><i class="fas fa-text-width"></i></button>
            ...
            <button class="img-btn" data-action="edit-alt" title="Edit Alt Text"><i class="fas fa-edit"></i></button>
            <button class="img-btn" data-action="add-caption" title="Add Caption"><i class="fas fa-comment"></i></button>
            <button class="img-btn" data-action="copy-image" title="Copy Image"><i class="fas fa-copy"></i></button>
            <button class="img-btn danger" data-action="delete" title="Delete Image"><i class="fas fa-trash"></i></button>
          </div>
        </div>
  ...
  function showTableBuilder(editorInstance) {
    const tableBuilderHtml = `
      <div class="ranjit-modal-content table-builder-modal">
        ...
        <div class="table-actions">
          <button class="table-btn secondary" id="previewTableBtn">👁️ Preview</button>
          <button class="table-btn primary" id="createTableBtn">✨ Create Table</button>
        </div>
      </div>
    `;
    ...
    $('#ranjitTableModal').off('click', '.grid-cell').on('click', '.grid-cell', function() {
      ...
      createAdvancedTable(editorInstance, rows, cols, selectedTemplate, options);
    ...
    $('#ranjitTableModal').off('click', '.quick-template-btn').on('click', '.quick-template-btn', function() {
      const preset = $(this).data('preset');
      applyPreset(preset);
    });
    
    // Create table
    $('#ranjitTableModal').off('click', '#createTableBtn').on('click', '#createTableBtn', function() {
  ...
  $(function () {
    ...
    $(document).on('click', '.dropdown-toggle', function(e) {
      ...
      // Handle direct image insert (primary action)
      if ($(this).data('command') === 'insertImageDirect') {
        if (activeEditorInstance) {
      ...
      <div class="ranjit-modal-content link-builder-modal">
        ...
        <div class="link-builder-section">
          <div class="input-group">
            ...
            <small class="input-hint">Enter the web address (URL)</small>
          </div>
          ...
          <div class="link-buttons">
            ...
            <button class="link-btn primary" id="insertLinkBtn">✨ Insert Link</button>
            <button class="link-btn secondary" id="removeLinkBtn">🗑️ Remove Link</button>
          </div>
        </div>
      </div>
    `;
  ...
  function initializeImageInteractions(imgId) {
    ...
    // Double click to replace image, single click to select
