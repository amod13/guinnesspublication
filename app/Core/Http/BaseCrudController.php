...
abstract class BaseCrudController extends BaseController
{
    ...
    public function dataCreate($extraData = [])
    {
        ...
        $data = array_merge($data, $this->extractData());
    ...
    protected function updateOrderInternal(Request $request, string $table, string $idColumn = 'id', string $orderColumn = 'sort_order')
    {
    ...
    /**
     * Extract common data needed for forms (create/edit)
     * Override this method in child controllers to provide specific data
     */
