                ...
                <div class="card-body text-center p-4">
                    <div class="mb-3">
                        @if (isset($data['record']->profile_image_url) && $data['record']->profile_image_url)
                            <img src="{{ $data['profile_image_url'] ?? null }}" alt="{{ $data['record']->name }}"
                        ...
                        <form action="{{ isset($data['record']->id) ? route('user.profile.update', $data['record']->id) : route('user.store') }}"
                            ...
                            <div class="card-body p-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <x-form.file-upload :id="'profile_image'" :label="'Profile Image'" :name="'profile_image'" :value="$data['profile_image_url'] ?? null" />
