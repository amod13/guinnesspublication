            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <div class="amd-soft-table-header p-3 d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0 text-black">SubDepartments</h3>
                        <a href="{{ route('subdepartment.create') }}" class="amd-btn amd-btn-primary amd-btn-small">
                            ...
                            <div class="amd-soft-header-right  ">
                                <div class=" p-3">
                                    <div class="search-wrapper">
                                        <input type="search" name="search" id="tableSearch"
                    ...
                    <div class="amd-soft-table-wrapper" tabindex="0" aria-label="Data table container">
                        <table class="amd-soft-table" role="grid" aria-describedby="table-description">
                            ...
                            <tbody>
                                @if (!empty($data['records']) && $data['records']->count())
                                    @foreach ($data['records'] as $index)
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a href="{{ route('subdepartment.edit', $index->id) }}"
                                                    class="btn btn-sm me-2">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('subdepartment.delete', $index->id) }}" method="POST"
                                ...
                                @else
                                    <tr>
                                        <td colspan="4" class="text-center">No sub department found.</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
