...
@section('content')
    <div class="card shadow-sm rounded-4 p-4 mb-4">
        <h5 class="card-title mb-3">Edit Department</h5>

        <form action="{{ route('department.update', $data['record']->id) }}" method="POST" id="departmentForm">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name', $data['record']->name) }}" placeholder="e.g., IT Department">
                @error('name')
