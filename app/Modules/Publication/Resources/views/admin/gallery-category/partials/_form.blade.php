<form class="row g-3"
    action="{{ isset($data['record']->id) ? route('gallery-category.update', $data['record']->id) : route('gallery-category.store') }}"
    ...
    <div class="col-12">
        <x-form.file-upload :id="'thumbnail_image_id'" :label="'Thumbnail Image'" :name="'thumbnail_image_id'" :value="isset($data['record']) ? $data['record']->getMediaUrl('thumbnail_image_id') : null" />
