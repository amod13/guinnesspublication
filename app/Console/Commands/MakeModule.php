...
{
    protected $signature = 'module:make {name} {--with-crud= : Generate module with sample CRUD entity} {--remove : Remove the module}';
    ...
    public function handle()
    {
        ...
        if ($this->option('remove')) {
            return $this->removeModule($name, $basePath);
        }
    ...
    protected function removeModule($name, $basePath)
    {
        ...
        if (!$this->confirm("Are you sure you want to remove module '{$name}' and all its files?")) {
